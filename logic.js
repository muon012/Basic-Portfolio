...
var display = function () {
    ...
    //  ajax call
    var name = $(this).text();
    var queryUrl = "http://api.giphy.com/v1/gifs/search?q=" + name + "&api_key=qGD6PCU4bUY2ex7AoiWWohjR593PzQ1h&limit=10";
    ...
    axios({
        ...
        .then(function (response) {
            ...
            for (var i = 0; i < database.length; i++) {
                ...
                // downloadLink.attr("href", database[i].images.original.url);
                downloadLink.attr("download", database[i].title + ".gif");
                downloadLink.attr("data-download", database[i].images.original.url);
...
var w = 0; // variable used for dynamicly creating names for the favorite gifs.
...
$(document).on("click", "#favorites", function () {
    ...
    $("#favoriteBtnDiv").prepend(newFavoriteBtn);
